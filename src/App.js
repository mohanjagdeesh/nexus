  ...
  return (
    <>
      <div className="home-container">
        {isMatch ? <SwipeableTemporaryDrawer /> : <Header />}
        <div className="top-container">
          <div className="home-top-container">
            ...
            <div className="home-top-sub-container">
              ...
              <p className="bar-soaps-para">
                Breathing new life into the humble bar soap are Nurture,
                <br />
                Polish and Refresh—three additions to the range, each imparting
                <br />a unique constellation of benefits.
              </p>
              <button type="button" className="discover-button">
                Discover Bar Soaps <BiRightArrowAlt />
              </button>
            </div>
          </div>
        </div>
          ...
          <div className="slider-container">
            <Slider {...settings}>
              <div className="brand-image">
                <div
                  className="home-top-sub-container"
                  style={{ marginBottom: "100px" }}
                >
                  <p className="bar-soaps-para" style={{ color: "black" }}>
                    For the body
                  </p>
                  <h1 className="home-heading" style={{ color: "black" }}>
                    {" "}
                    An expression of care
                  </h1>
                  <p className="bar-soaps-para" style={{ color: "black" }}>
                    Aesop formulations offer the body deserving care, to
                    cleanse, replenish, and nourish skin. Each product is a
                    sensory pleasure to use with its own delightful aroma.
                    <br />
                  </p>
                  <button
                    type="button"
                  ...
                  >
                    See All Body Care <BiRightArrowAlt />
                  </button>
                </div>
              </div>
              ...
              <div className="brand-image">
                ...
                <h1 className="nature-bar-soaps-heading">
                  <Tooltip
                    title="Link to nature bar soap"
                    placement="bottom-end"
                  >
                    Nature Bar Soaps
                  </Tooltip>
                </h1>
                <p className="nature-bar-sopas-desc">
                  Offers a mild yet effective cleanse
                </p>
              </div>
        ...
        <dvi className="warp-up-main-container">
          <div className="warp-up-sub-container">
            ...
            <p className="warp-up-para">
              In The Athenaeum, our digital reading room:
              <br />
              a guide to ensuring a healthy complexion through
              <br />
              the warmer months.
            </p>
            <button type="button" className="warp-up-button">
              ...
              <div className="brand-image">
                <div className="home-top-sub-container">
                  ...
                  <p className="bar-soaps-para" style={{ color: "black" }}>
                    ...
                    nourishment, and protection through discerning rituals.
                    Explore requisite skin care for all skin types.
                    <br />
                  </p>
                  <button
                    type="button"
            ...
            <Slider {...settings}>
              <div className="brand-image">
                <div className="home-top-sub-container">
                  ...
                  <p className="bar-soaps-para" style={{ color: "black" }}>
                    Our range of aromatic formulations for the home are
                    practical and pleasing in equal measure.
                    <br />
                  </p>
                  <button
                    type="button"
